...
function(ADD_ARROW_FUZZING REL_FUZZING_NAME)
  ...
  target_compile_options(${FUZZING_NAME}
    PRIVATE -ffunction-sections -fdata-sections -fsanitize=fuzzer)
  set_target_properties(${FUZZING_NAME} PROPERTIES
    LINK_FLAGS "-Wl,--gc-sections -fsanitize=fuzzer"
    LABELS "fuzzing")
endfunction()
